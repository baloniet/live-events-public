...
@NgModule({
  declarations: [
    ...
    KindFormComponent, LocationFormComponent, TypeFormComponent, ProgramComponent, CheckoutFormComponent, StatComponent, MemberStatComponent, RoomStatComponent, TeachStatComponent
  ],
  imports: [
    BrowserModule,
