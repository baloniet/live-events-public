...
@NgModule({
  declarations: [
    ...
    GenListComponent,
    ValuesPipe, KeysPipe,
    FormTitleComponent, FormButtonComponent, CommuneFormComponent, EducationFormComponent, StatementFormComponent, CitizenshipFormComponent, PersonFormComponent, AddressComponent
  ],
  imports: [
    BrowserModule,
    ReactiveFormsModule,
