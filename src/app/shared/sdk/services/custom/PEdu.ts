...
export class PEduApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public updateByIdEducation(id: any, fk: any, data: any = {}): Observable<any> {
   ...
   * </em>
   */
  public getEducation(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PEdus/:id/education";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createEducation(id: any, data: any = {}): Observable<any> {
   ...
   *  - `count` – `{number}` - 
   */
  public countEducation(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public createManyEducation(id: any, data: Array<any> = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PEdus/:id/education";
    let _routeParams: any = {
