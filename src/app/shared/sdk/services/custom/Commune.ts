...
export class CommuneApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public create(data: any = {}): Observable<Commune> {
   ...
   * </em>
   */
  public upsert(data: any = {}): Observable<Commune> {
   ...
   * </em>
   */
  public upsertWithWhere(where: any = {}, data: any = {}): Observable<Commune> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public findById(id: any, filter: LoopBackFilter = {}): Observable<Commune> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Communes/:id";
    let _routeParams: any = {
   ...
   * </em>
   */
  public find(filter: LoopBackFilter = {}): Observable<Array<Commune>> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Communes";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public findOne(filter: LoopBackFilter = {}): Observable<Commune> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Communes/findOne";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public createMany(data: Array<any> = []): Observable<Array<Commune>> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Communes";
    let _routeParams: any = {};
