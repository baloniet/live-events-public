...
export class PersonApi extends BaseLoopBackApi {
  ...
  /**
   * Add a related item by id for statements.
   *
   ...
   * </em>
   */
  public linkStatements(id: any, fk: any, data: any = {}): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/People/:id/statements/rel/:fk";
  ...
  /**
   * Remove the statements relation to an item by id.
   *
   * @param any id PersistedModel id
   *
   * @param any fk Foreign key for statements
   ...
   */
  public unlinkStatements(id: any, fk: any): Observable<any> {
  ...
  /**
   * Check the existence of statements relation to an item by id.
   *
   * @param any id PersistedModel id
   *
   * @param any fk Foreign key for statements
   ...
   * </em>
   */
  public existsStatements(id: any, fk: any): Observable<any> {
   ...
   * </em>
   */
  public getStats(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/People/:id/stats";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getStatements(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/People/:id/statements";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getEmp(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/People/:id/emp";
    let _routeParams: any = {
