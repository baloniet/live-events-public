...
export class CitizenshipApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public create(data: any = {}): Observable<Citizenship> {
   ...
   * </em>
   */
  public upsert(data: any = {}): Observable<Citizenship> {
   ...
   * </em>
   */
  public upsertWithWhere(where: any = {}, data: any = {}): Observable<Citizenship> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public findById(id: any, filter: LoopBackFilter = {}): Observable<Citizenship> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Citizenships/:id";
    let _routeParams: any = {
   ...
   * </em>
   */
  public find(filter: LoopBackFilter = {}): Observable<Array<Citizenship>> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Citizenships";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public findOne(filter: LoopBackFilter = {}): Observable<Citizenship> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public createMany(data: Array<any> = []): Observable<Array<Citizenship>> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Citizenships";
    let _routeParams: any = {};
